...
export default function Registration() {
    ...
    const handleSubmit = (e) => {
        ...
        const newErrors = {
            ...
            confirmPassword: trimmedPassword === trimmedConfirmPassword ? '' : 'Passwords do not match.',
        };
    ...
    return (
        <div className='justify-center items-center flex flex-col' style={{backgroundImage:`url(${registrationimg})`,height: '100vh', width: '100%', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', }}>
            <form onSubmit={handleSubmit} className=" max-w-[400px] w-3/4 mx-auto p-4 rounded-lg bg-white/20 backdrop-blur-lg ">
                ...
                <button type="submit" className="border py-2 rounded-lg w-full my-5 bg-indigo-950 hover:bg-indigo-900 text-white">
                    Next
                </button>
            </form>
        </div>
